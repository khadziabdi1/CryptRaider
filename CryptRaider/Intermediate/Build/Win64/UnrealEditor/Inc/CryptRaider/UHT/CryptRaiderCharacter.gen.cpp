...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_CryptRaider_OnUseItem__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_CryptRaider, nullptr, "OnUseItem__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_CryptRaider_OnUseItem__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_CryptRaider_OnUseItem__DelegateSignature_Statics::Function_MetaDataParams) };
...
void FOnUseItem_DelegateWrapper(const FMulticastScriptDelegate& OnUseItem)
{
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACryptRaiderCharacter_Statics::NewProp_OnUseItem = { "OnUseItem", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACryptRaiderCharacter, OnUseItem), Z_Construct_UDelegateFunction_CryptRaider_OnUseItem__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACryptRaiderCharacter_Statics::NewProp_OnUseItem_MetaData), Z_Construct_UClass_ACryptRaiderCharacter_Statics::NewProp_OnUseItem_MetaData) }; // 3357126195
	...
	struct Z_CompiledInDeferFile_FID_Users_Korisnik_Documents_Unreal_Projects_CryptRaider_CryptRaider_CryptRaider_Source_CryptRaider_CryptRaiderCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Korisnik_Documents_Unreal_Projects_CryptRaider_CryptRaider_CryptRaider_Source_CryptRaider_CryptRaiderCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACryptRaiderCharacter, ACryptRaiderCharacter::StaticClass, TEXT("ACryptRaiderCharacter"), &Z_Registration_Info_UClass_ACryptRaiderCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACryptRaiderCharacter), 1560656362U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Korisnik_Documents_Unreal_Projects_CryptRaider_CryptRaider_CryptRaider_Source_CryptRaider_CryptRaiderCharacter_h_901558274(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_Users_Korisnik_Documents_Unreal_Projects_CryptRaider_CryptRaider_CryptRaider_Source_CryptRaider_CryptRaiderCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Korisnik_Documents_Unreal_Projects_CryptRaider_CryptRaider_CryptRaider_Source_CryptRaider_CryptRaiderCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
